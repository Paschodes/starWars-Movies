        ...
        <div className='info-box'>
            <div className='section-1'>
                <div className='back-list'>
                    <Link to='/' className='back'>&larr; Back to List</Link>
                </div>
                    ...
                    <ul className='starship-list'>
                        {
                            info.starships.map(starship => (
                                <Starships url={starship} key={starship}>{starship}</Starships>
                            ))
                        }
                    </ul>
                </div>
                    ...
                    <ul className='vehicle-list'>
                        {
                            info.vehicles.map(vehicle => (
                                <Vehicles url={vehicle} key={vehicle}>{vehicle}</Vehicles>
                            ))
                        }
                    </ul>
                </div>
